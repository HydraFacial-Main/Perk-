...
//                              OBJECT'S IDs
/////////////////////////////////////////////////////////////////////////////
#define KEY_HELD 15	//seconds divided by 10
...
extern FONT_EXTERNAL Arial_Bold_48;
extern IMAGE_EXTERNAL CCWarning;
...
//    TouchCalibration();
    ...
    while(1)
    {
		...
		if(standbyFlag == FALSE)
		{
			...
			if((standbyMode == FALSE) || (imageState == CLEANSE_IMAGE) || (imageState == WARNING_IMAGE) ||(imageState == REMINDER_IMAGE))
			{
    	 ...
    	 //		if(buttonReleased == 0)
    			{
    		        ...
    		        else
    		        {
    					if(!continuousFlag)
    					{
	    					...
	    					PutImage(0, 0, (void *) &CCWarning, 1);
	    					SetFont((void *)  &Arial_Bold_48);
    						SetColor(WHITE);
	    	
	    					uitoa(DaysLeft, (BYTE*)String);
	    					width = GetTextWidth(String, (void *) &Arial_Bold_48);
	    					height = GetTextHeight((void *) &Arial_Bold_48);
	    				
	    					OutTextXY(137 - (width >> 1), 282 - (height >> 1), (XCHAR *)String);

	    //(84,230), (188,334)
	    	
	    					imageState = DAYS_LEFT;
...
*/    
    			...
    			//(84,230), (188,334)
    								...
    								while(!OutTextXY(84, 230, (XCHAR *)String));	//coordinate here???
